// ┌─ estreux:expanded ──────────────────────────────────────────────
// │ source : ai-insight-card.eux  (sha256:44cc599c87b1)
...
export class AiInsightCard extends EstreUVElement {
  ...
  static styles = css`
    ...
    .body { font-size: .9rem; margin-bottom: 8px; color: var(--aic-ink, inherit); }
    .q { color: var(--aic-dim, #9aa0ae); font-size: .86rem; font-style: italic; margin-bottom: 10px; }
    .acts { display: flex; gap: 8px; }
    button { background: var(--aic-btn-bg, #1e2230); border: 1px solid var(--aic-btn-line, #2a2f3d); color: var(--aic-dim, #9aa0ae);
